...
const SkeletonCardCreator = ({ cards }) => {
  return Array(cards)
    .fill(0)
    .map((item, i) => (
      <div
        key={i}
        className="flex-1 h-auto rounded-lg bg-neutral-900 animate-pulse p-6 pt-10 flex flex-col"
      >
        <div className="w-28 h-28 rounded-full bg-neutral-800 animate-pulse mx-auto mb-4"></div>
...
export default SkeletonCardCreator;
